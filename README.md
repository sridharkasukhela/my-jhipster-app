...
To build the final jar and optimize the myjhapp application for production, run:
...
Then navigate to [http://localhost:37300](http://localhost:37300) in your browser.
