...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERGROUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERGROUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERGROUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERGROUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERGROUP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERGROUP actions', async () => {
      const arg = 42666;
