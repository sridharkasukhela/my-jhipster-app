...
import { deleteEntity, getEntity } from './user-group.reducer';
...
export const UserGroupDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myjhappApp.userGroup.delete.question">
        <Translate contentKey="myjhappApp.userGroup.delete.question" interpolate={{ id: userGroupEntity.id }}>
